...
# Update QID106's QuestionText with the new HTML (reference sheet at top, no item details or dropdown)
...
for el in data.get('SurveyElements', []):
    if el.get('Element') == 'SQ' and el.get('PrimaryAttribute') == 'QID106':
        ...
        updated = True
        print('Updated QID106 QuestionText with new HTML (reference sheet at top, no item details/dropdown)')
